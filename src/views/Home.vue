...
<template>
  <div class="h-full flex flex-col bg-base-100">
    <!-- Header Section -->
    <div class="flex-none px-4 pt-4 md:px-6 md:pt-6 pb-2">
    ...
    <div class="flex-1 overflow-y-auto min-h-0 px-4 pb-4 md:px-6 md:pb-6 custom-scrollbar">
      <div class="container mx-auto max-w-7xl min-h-full flex flex-col">
